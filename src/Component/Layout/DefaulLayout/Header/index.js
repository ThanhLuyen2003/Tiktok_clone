...
function Header() {
    ...
    const [history, setHistory] = useState([{ data: currentUser ? userMenu : MENU_ITEMS }]);
    ...
    const renderItem = (item, index) => {
        ...
        return (
            <div
                key={item.title}
                className={cx({ separate: separate })}>
                <Button
                ...
                <div className={cx('actions')}>
                    {
                        currentUser
                            ...
                            <>
                                ...
                                <button className={cx('actions-btn')}>
                                    <MessageIcon width={22} height={22} fill='rgba(22, 24, 35, 0.8)' />
                                </button>
