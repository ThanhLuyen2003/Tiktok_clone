...
import Headerr from '../../../Poper/Menu/header';
...
const MENU_ITEMS = [
    ...
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 576 512">
...
const userMenu = {
    data: [
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 448 512">
...
function Header() {
    ...
    const renderItem = (item, index) => {
        ...
        const separate = item.separate;

        return (
            <div className={cx({ separate: separate })}>
                <Button
                    ...
                    to={item.to}
                    leftIcon={item.icon}>
                    <h4 style={{ marginLeft: '6px' }}>{item.title}</h4>
                </Button>
            </div>
        )
            ...
            <div className={cx('inner')}>
                ...
                >
                    <div className={cx('search')}>
                        <input placeholder='Search accounts and videos' onChange={(txt) => setSearchResult(txt)} />
                ...
                <div className={cx('actions')}>
                            ...
                            <>
                                <Tippy content='Upload video' placement='bottom'>
                                    <button className={cx('actions-btn')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill='rgba(22, 24, 35, 0.8)' width="22" height="22" viewBox="0 0 640 512">
                                ...
                                <button className={cx('actions-btn')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill='rgba(22, 24, 35, 0.8)' width="22" height="22" viewBox="0 0 512 512">
                    ...
                    <HeadlessTippy
                        ...
                        render={attts => (
                            <div className={cx('content')} tabIndex={-1} {...attts}>
                                <Wrapper>
                                    {history.length > 1 &&
                                        <Headerr title='Language' onBack={() => {
                                    ...
                                    <div >
                                        {currentUser
                                            ?
                                            userMenu.data.map((item, index) => renderItem(item, index))
                                            :
                                            current.data.map((item, index) => renderItem(item, index))
                    ...
                    >
                        {
                            currentUser
                                ...
                                <img
                                    ...
                                    src='https://bloganchoi.com/wp-content/uploads/2022/12/1507-hinh-nen-luffy-gear-5-one-piece-cuc-ngau8-scaled.jpg'
                                    alt='cc'
                                />
                                :
                                <button className={cx('more-btn')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 128 512">
